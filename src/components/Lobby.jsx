...
function Lobby({ onCreateRoom, onJoinRoom, roomId, gameState, playerId, socket }) {
        ...
        <div className="room-container">
            ...
            <div className="players-grid">
              {gameState?.players.map((player) => (
                ...
                >
                  ...
                  {player.id === playerId && <div className="you-badge">You</div>}
                  {player.id === gameState.hostId && <div className="host-badge">Host</div>}
                </div>
              ))}
            </div>
          </div>
          ...
          {gameState?.hostId === playerId && (
            <button
              ...
              disabled={!gameState || gameState.players.length < 3}
            >
              Start Game
            </button>
          )}
          ...
          {gameState && gameState.players.length < 3 && (
            <p className="waiting-text">Waiting for more players (minimum 3)...</p>
          )}
        </div>
      ) : (
